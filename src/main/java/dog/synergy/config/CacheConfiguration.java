...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, dog.synergy.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, dog.synergy.repository.UserRepository.USERS_BY_EMAIL_CACHE);
